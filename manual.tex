...
\bigbreak\noindent
{\bf Postscript}: {\tt sgf2dg} is the successor program to
{\tt sgf2tex}. The Perl script has been rewritten from scratch by
Reid.  Plugin output converters produce several formats besides \TeX. The
\TeX\ fonts have been supplemented with a few more symbols to support SGF
FF4.
